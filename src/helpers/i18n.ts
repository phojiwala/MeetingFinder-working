...
export const languages: LanguageDictionary = {
    ...
    bg: {
        ...
        strings: {
            ...
            email_use: 'Изпрати имейл {{value}}',
            filters: 'филтри',
            friday: 'петък',
            language: 'език',
            monday: 'понеделник',
            no_results: 'Няма резултати, съответстващи на избраните филтри:',
            ongoing: 'продължава',
            report: 'Report Problem',
            report_comments: 'Comments',
            report_confirm: 'Thanks for letting us know. We will follow up with the group!',
            ...
            sunday: 'неделя',
            telephone: 'телефон',
            telephone_use: 'Обадете се {{value}}',
            thursday: 'четвъртък',
            timezone: 'часова зона',
            tuesday: 'вторник',
            video_use: 'Присъединете се {{value}}',
            wednesday: 'сряда',
            twenty_four_seven: '24/7'
        }
    },
    cs: {
        ...
        strings: {
            ...
            close: 'Zavřít',
            email: 'E-mail',
            email_use: 'E-mailem {{value}}',
            filters: 'Filtry',
            friday: 'pátek',
            language: 'Jazyk',
            monday: 'pondělí',
            no_results: 'Vybraným filtrům neodpovídají žádné výsledky:',
            ongoing: 'Pokračující',
            report: 'Report Problem',
            report_comments: 'Comments',
            report_confirm:
            ...
            sunday: 'neděle',
            telephone: 'Telefon',
            telephone_use: 'Volání {{value}}',
            thursday: 'čtvrtek',
            timezone: 'Časové pásmo',
            tuesday: 'úterý',
            video_use: 'vstoupit do {{value}}',
            wednesday: 'středa',
            twenty_four_seven: '24/7'
        }
    },
    ...
    nl: {
        ...
        strings: {
            ...
            language: 'Taal',
            monday: 'Maandag',
            no_results: 'Er komen geen resultaten overeen met de geselecteerde filters:',
            ...
            sunday: 'Zondag',
            telephone: 'Telefoon',
            telephone_use: 'Telefoongesprek {{value}}',
            thursday: 'Donderdag',
            timezone: 'Tijdzone',
            tuesday: 'Dinsdag',
            video_use: 'Deelnemen {{value}}',
            wednesday: 'Woensdag',
            twenty_four_seven: '24/7'
        }
    },
    ...
    is: {
        ...
        strings: {
            ...
            close: 'Loka',
            email: 'Tölvupóstur',
            email_use: 'Tölvupóstur {{value}}',
            filters: 'Síur',
            friday: 'föstudag',
            language: 'Tungumál',
            monday: 'Mánudagur',
            no_results: 'Engar niðurstöður passa við valdar síur:',
            ongoing: 'Í gangi',
            report: 'Report Problem',
            report_comments: 'Comments',
            report_confirm: 'Thanks for letting us know. We will follow up with the group!',
            ...
            sunday: 'sunnudag',
            telephone: 'Sími',
            telephone_use: 'Hringdu í {{value}}',
            thursday: 'fimmtudag',
            timezone: 'Tímabelti',
            tuesday: 'þriðjudag',
            video_use: 'Taka þátt {{value}}',
    ...
    tr: {
        ...
        strings: {
            ...
            close: 'Kapat',
            email: 'E-posta',
            email_use: 'E-posta {{value}}',
            filters: 'Filtreler',
            friday: 'Cuma',
            language: 'Dil',
            monday: 'Pazartesi',
            no_results: 'Seçilen filtrelerle eşleşen sonuç yok:',
            ...
            sunday: 'Pazar',
            telephone: 'Telefon',
            telephone_use: 'Telefon etmek {{value}}',
            thursday: 'Perşembe',
            timezone: 'Saat dilimi',
            tuesday: 'Salı',
            video_use: 'Katılmak {{value}}',
            wednesday: 'Çarşamba',
            twenty_four_seven: '24/7'
        }
    }
